...
$sqlid= "SELECT * FROM locations ORDER BY name";
	...
	{ 
										?>
                                            <tr class="tr-shadow">
                                               ...
                                               <td><img src="locations/<?php echo $rowid['img_url']; ?>" style="width:100px;height:100px;object-fit:cover;"></td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        <form action="edit_location.php" method="POST">
										<input type="hidden" value="<?php echo $rowid['id']; ?>" name="loc_id">
                                                       <button type="submit" class="item btn-secondary mb-1" data-toggle="modal" data-target="#mediumModa<?php echo $rowid['id']; ?>">
