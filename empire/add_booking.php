            ...
            <div class="main-content">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="insert_booking.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <option value="Zimbabwe">Zimbabwe</option>
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="date" id="email-input" name="arrival_date" placeholder="Arrival Date" class="form-control">
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="email-input" name="nod" placeholder="NOD" class="form-control">
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="email-input" name="adults" placeholder="Adults" class="form-control">
                                          ...
                                          <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="email-input" name="children" placeholder="Children" class="form-control">
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="email-input" name="babies" placeholder="Babies" class="form-control">
