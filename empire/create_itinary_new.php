...
echo $num_ref; // returns 04
	...
	<?php } ?>
						...
						<form id="regForm" action="insert_itinery.php" method="POST">
...
#order_table01{over-flow:hidden;}
  </style>
							...
							<div class="col-md-12 table-responsive ">
								...
								<tr>
									...
									<th style="width:80%">Attractions</th>	
...
$sqlid= "SELECT * FROM locations";
	...
	{ 
										...
										<label><input type="radio" name="location<?php echo $num_padded; ?>" class="location<?php echo $num_padded; ?>" id="<?php echo $rowid['id']; ?>" value="<?php echo $rowid['id']; ?>" style="float: left; width: auto;  margin-top: 6px; margin-right: 10px;"> <span style="float:left"><?php echo $rowid['name']; ?></span></label><br>
										<?php } ?> </td>
									<td class="tb_ser">
									...
									<br>
									<br>
									<div class="table-responsive" id="order_table<?php echo $num_padded; ?>" style="    background: #c6ffca; padding: 5px;"> 
	...
	<?php } ?>
											...
											<h4>Pricing Plan</h4>
											 ...
											 <div class="row form-group" style="background:#fff;padding:10px">
                                                <div class="col col-md-3">
                                                    <label for="file-input" class=" form-control-label">Price per person</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="number" placeholder="Amount" name="price" class="form-control-label" style="width:30%;float:left;"step="0.01" title="Currency" pattern="^\d+(?:\.\d{1,2})?$" onblur="
this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)?'inherit':'red'
">
                                                    <input type="text"  name="curruncy" placeholder="Curruncy"  style="width:30%;float:left;" class="form-control-label">
												
                                                </div>
                                            </div>
						<h5><b>Special Note For Whole Tour</b></h5>
								
									<textarea name="spe_note"style="border:1px solid #ddd;width:100%;height:200px;"> </textarea>
					   </div>
...
$('#nextBtn').on('click', function(){
  ...
  $('.right_list .list-group-item input[type="checkbox"]').attr('checked', true).triggerHandler('click');
});
$('#nextBtn').on('click', function(){
$('.left_list .list-group-item input[type="checkbox"]').prop("checked", false);
});
